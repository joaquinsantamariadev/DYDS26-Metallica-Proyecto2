...
class CompleteSaleUseCaseTest {
    ...
    private val useCase = CompleteSaleUseCaseImpl(validateStock, inventoryRepo, saleRepo)
    ...
    private fun product(id: Int, stock: Int) = com.app.inventory.domain.entity.Product(
